...
RSpec.describe Item do
  ...
  describe 'class methods' do 
    ...
    it 'can search by minimum and maximum price and return one first object in an alphabitzed list' do
      ...
      expect(Item.search_min_max_price(50.00, 150.00)).to eq(item_4)
      expect(Item.search_min_max_price(5.00, 20.00)).to eq(item_1)
      expect(Item.search_min_max_price(48.99, 50.00)).to eq(item_2)
    end
  end
end 
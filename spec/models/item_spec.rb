...
RSpec.describe Item do
  ...
  describe 'class methods' do 
    ...
    it 'can search by minimum and maximum price and return one first object in an alphabitzed list' do
      merchant = Merchant.create!(name: "Harold the Big")
      ...
      expect(Item.search_min_max_price(50.00)).to eq(item_2)
      expect(Item.search_min_max_price(9.00)).to eq(nil)
      expect(Item.search_min_max_price(20.00)).to eq(item_1)
      expect(Item.search_min_max_price(50.01)).to eq(item_2)
    end
  end
end 